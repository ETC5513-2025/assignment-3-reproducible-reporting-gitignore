...
2.  2\. How do weekday and weekend patterns differ?

3.  3\. What are the seasonal usage differences between user types?

4.  4\. What hours see the highest demand?
:::
...
-   Using time-based demand trends to optimize staff scheduling, re-balancing logistics, and promotional campaigns
