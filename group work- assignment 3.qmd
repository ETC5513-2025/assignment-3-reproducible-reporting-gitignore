...
This reproducible workflow, using R, Quarto, and Git, can be applied to similar datasets in other cities, helping planners and operators better manage bike or e-scooter fleets.
